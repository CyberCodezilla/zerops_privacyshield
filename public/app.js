document.addEventListener('DOMContentLoaded', () => {
  ...
  // Multi-Language Presets (Hinglish, Minglish, English)
  const PRESETS = {
    ...
    keys: `2026-08-09T08:30:10Z [CRITICAL] AWS & DB Connection Incident\nDatabase URI: postgresql://admin:P@ssw0rd123@db.internal:5432/prod\nExposed Credential: AKIAIOSFODNN7EXAMPLE\nAuthorization Token: Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c\nGitHub PAT: ghp_1234567890abcdefghijklmnopqrstuvwxyz`
  };
  ...
  function renderHighlightedText(text) {
    if (!text) return '';
    const redactionPattern = /(\[[A-Z_]+_REDACTED\]|Bearer \[TOKEN_REDACTED\])/g;
  ...
  btnCopy.addEventListener('click', () => {
    ...
    if (rawText && !rawText.includes('Click "EXECUTE SANITIZATION"')) {
      ...
      setTimeout(() => {
        btnCopy.innerHTML = `<svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012 2"></path></svg> COPY SANITIZED PAYLOAD`;
      }, 2000);
    }
  });
